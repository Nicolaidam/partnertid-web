          ...
          >
            <CardContent className="p-6">
              <div className="flex items-start mb-4">
                ...
                <p className="text-foreground italic font-cormorant text-base leading-relaxed flex-1">
                  &quot;{testimonial.quote}&quot;
                </p>
              </div>
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="border border-brand-warm/30 bg-gradient-to-br from-brand-warm/5 to-brand-sand/10">
          <CardContent className="p-8 text-center">
            <h3 className="text-2xl font-cormorant font-extrabold text-foreground mb-4">
              Hvorfor kvinder vælger Partnertid
            </h3>
            <p className="text-muted-foreground font-cormorant text-lg leading-relaxed mb-6">
      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        <div className="relative bg-white shadow-xl rounded-3xl p-8 md:p-16 border border-white/50 backdrop-blur-sm overflow-hidden">
          ...
          <div className="relative text-center">
            ...
            <h2 className="text-3xl md:text-5xl font-cormorant font-extrabold mb-6 text-foreground leading-tight">
              Start jeres ugentlige <br className="hidden md:block" />
              <span className="text-brand-warm">rutine</span> i dag
            </h2>
            
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto font-cormorant">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10 max-w-3xl mx-auto">
              <div className="flex flex-col items-center p-4 rounded-lg bg-brand-sand/5">
                ...
                <p className="text-sm font-medium text-foreground font-cormorant">Første måned gratis</p>
                <p className="text-xs text-muted-foreground mt-1">Ingen binding</p>
              </div>
              <div className="flex flex-col items-center p-4 rounded-lg bg-brand-sand/5">
                <div className="text-2xl mb-2">🔒</div>
                <p className="text-sm font-medium text-foreground font-cormorant">100% anonymt</p>
                <p className="text-xs text-muted-foreground mt-1">Alt mellem jer to</p>
              </div>
              <div className="flex flex-col items-center p-4 rounded-lg bg-brand-sand/5">
                <div className="text-2xl mb-2">⏱️</div>
                <p className="text-sm font-medium text-foreground font-cormorant">30-45 min/uge</p>
