    ...
    features: [
      {
        ...
        icon: <Heart className="h-6 w-6 text-brand-warm" />,
      },
      {
    ...
    features: [
      {
        ...
        icon: <MessageCircle className="h-6 w-6 text-brand-green" />,
      },
      {
    ...
    features: [
      {
        ...
        icon: <TrendingUp className="h-6 w-6 text-brand-terracotta" />,
      },
      {
        title: "I jeres tempo",
        ...
        icon: <Clock className="h-6 w-6 text-brand-terracotta" />,
      },
    ],
  },
];
