    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-['Playfair_Display'] font-light tracking-wider mb-4 flex items-center">
          ...
          <div>
            <h4 className="text-lg font-playfair font-light mb-4">Kontakt</h4>
            <p className="text-gray-400 mb-2 font-cormorant text-lg">Har du spørgsmål? Kontakt os.</p>
            <a href="mailto:info@partnertid.dk" className="text-primary hover:text-primary/80 transition-colors font-cormorant">
              info@partnertid.dk
            </a>
          </div>
        </div>
        
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500 text-sm font-cormorant">
