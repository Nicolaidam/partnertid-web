    ...
    <footer className="bg-foreground py-12 text-background">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div>
            <h3 className="mb-4 flex items-center text-subtitle font-normal tracking-label">
              <Heart className="mr-1 size-5 text-brand-warm" fill="currentColor" strokeWidth={1.5} />
              <span>Partnertid</span>
            </h3>
            <p className="text-lead text-background/70">
              Moderne parterapi guidet af AI, baseret på videnskabeligt anerkendte metoder.
            </p>
          </div>
          
          <div>
            <h4 className="mb-4 text-lead font-normal tracking-button">Links</h4>
          ...
          <div>
            <h4 className="mb-4 text-lead font-normal tracking-button">Kontakt</h4>
            <p className="mb-2 text-lead text-background/70">Har du spørgsmål? Kontakt os.</p>
        ...
        <div className="mt-8 border-t border-background/10 pt-8 text-center text-body-sm text-background/50">
