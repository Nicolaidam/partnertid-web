    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-normal tracking-[0.12em] mb-4 flex items-center">
          ...
          <div>
            <h4 className="text-lg font-normal tracking-[0.08em] mb-4">Links</h4>
          ...
          <div>
            <h4 className="text-lg font-normal tracking-[0.08em] mb-4">Kontakt</h4>
            <p className="text-gray-400 mb-2 text-lg">Har du spørgsmål? Kontakt os.</p>
            <a href="mailto:info@partnertid.dk" className="text-primary hover:text-primary/80 transition-colors">
              info@partnertid.dk
            </a>
          </div>
        </div>
